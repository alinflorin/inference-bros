...
With desktop based chat apps you will get invalid SSL cert (which is normal, it's self signed). Use http://kubeai-insecure.local.inferencebros.com/openai/v1 as URL.  
