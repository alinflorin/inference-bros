...
Visit our documentation portal for detailed guides, video tutorials, and community examples.`
  ...
  return (
    <div className="bg-black w-screen h-screen fixed inset-0">
      {/* Desktop Layout */}
        ...
        <div className="grid grid-cols-[400px_1fr] grid-rows-[100px_1fr_80px_10px_100px_10px] h-full bg-black text-white font-mono">
          ...
          <div className="bg-black flex flex-col justify-center px-10 gap-5 row-start-2">
            ...
            {menuItems.map((item) => (
              <div
                key={item}
                className={`text-5xl font-bold tracking-tight cursor-pointer select-none transition-all duration-300 ${
                  hoveredMenu && hoveredMenu !== item ? 'opacity-30 blur-sm' : 'opacity-100 blur-0'
                }`}
      ...
      {/* Mobile Layout */}
      <div className="lg:hidden min-h-screen bg-black text-white font-mono">
        {/* Mobile Header */}
        <div className="bg-black flex items-center justify-between px-6 py-6 sticky top-0 z-40">
        ...
        {isMobileMenuOpen && (
          <div className="fixed inset-0 bg-black z-50 flex flex-col pt-20">
            <div className="flex-1 flex flex-col justify-center px-8 gap-6">
              <div className="text-xs opacity-50 mb-2 tracking-wider">$ ls /menu</div>
              {menuItems.map((item) => (
                <div
                  key={item}
        ...
        {!isMobileMenuOpen && (
          <div className="flex flex-col">
            {/* Dynamic Window */}
            <div className="bg-black flex flex-col justify-center items-center p-8 min-h-[400px]">
              <div className="text-4xl font-light tracking-[3px] text-center leading-[1.3] mb-6">
                {content[activeMenu].title}
              </div>
              <div className="text-base tracking-[2px] opacity-90 mb-4">
                {content[activeMenu].subtitle}
              </div>
              <div className="text-sm max-w-lg text-center opacity-80 leading-relaxed px-4">
                {content[activeMenu].description}
              </div>
            </div>
            ...
            {/* System Status */}
            <div className="bg-black px-6 py-6 border-t-2 border-white">
              <div className="text-2xl font-bold tracking-wide mb-3">System Status</div>
            ...
            {/* Footer */}
            <div className="bg-black flex justify-center items-center px-6 py-8 border-t-2 border-white">
              <div className="flex flex-wrap gap-4 text-xs tracking-[2px] justify-center">
